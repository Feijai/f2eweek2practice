...
import { activeColorState, toolState } from "../Atom";
import { roundRect, pickColor, drawOval } from "../../utils/drawFunc";
...
const CanvasBox = () => {
    ...
    useEffect(() => {
        const canvas = canvasRef.current; //reacet 17以上需要設定
        const ctx = canvas.getContext("2d");
        const handleDrawCanvas = (point: pointIF, ctx: any) => {
            let width, height;
