...
import { SignPannelToolCss } from "./toolStyle";
import { AddSignInCanvas } from "MyTypes";
import bold1 from "../../assets/bold1.png";
import bold2 from "../../assets/bold2.png";
import bold3 from "../../assets/bold3.png";
...
function SignPannelTool(props: any) {
    ...
    if (isWrite) {
      ...
      if (isPC || window.orientation === 90) {
        ...
        img.onload = function () {
          ...
          ctx.drawImage(
            img,
            clipSize.h / 2 - img.width / 2,
            clipSize.w / 2 - img.height / 2
          );
          ctx.restore();
          setTimeout(async () => {
  ...
  return (
    <SignPannelToolCss>
      <div className="canvas-write-tool">
        ...
        <div className="button-wrap">
          <button className="button clear" onClick={clearSign}>
            clean
          </button>
          <button className="button save" onClick={saveSign}>
            save
          </button>
        </div>
      ...
      <div className="canvas-write-title">
        <img
          src="https://buynao.oss-cn-beijing.aliyuncs.com/iep/close.png"
